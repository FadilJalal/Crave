    ...
    <div className='hero'>
      ...
      <div className='hero-visual'>
        <div className='hero-card hero-card-1'>
          ...
          <div>
            <p className='hc-name'>Margherita Pizza</p>
            <p className='hc-info'>25 min · $12.99</p>
          </div>
        </div>
        <div className='hero-card hero-card-2'>
          <div className='hc-icon'>🍜</div>
          <div>
            <p className='hc-name'>Ramen Bowl</p>
            <p className='hc-info'>20 min · $14.50</p>
          </div>
        </div>
        <div className='hero-card hero-card-3'>
          <div className='hc-icon'>🥗</div>
          <div>
            <p className='hc-name'>Greek Salad</p>
            <p className='hc-info'>15 min · $9.99</p>
          </div>
        </div>
