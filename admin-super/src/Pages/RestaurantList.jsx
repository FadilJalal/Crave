...
const s = {
  ...
  filtersCard:     { background: "var(--card)", border: "1px solid var(--border)", borderRadius: 16, padding: 16 },
  ...
  searchBox:       { display: "flex", alignItems: "center", gap: 8, padding: "0 12px", borderRadius: 10, border: "1px solid var(--border)", background: "var(--bg)", height: 40 },
  searchInput:     { border: "none", outline: "none", background: "transparent", width: "100%", fontSize: 14 },
  select:          { height: 40, borderRadius: 10, border: "1px solid var(--border)", background: "var(--bg)", padding: "0 10px", outline: "none", width: "100%", color: "var(--text)" },
  clearBtn:        { height: 40, padding: "0 16px", borderRadius: 10, background: "#1e293b", color: "#fff", border: "none", cursor: "pointer", fontWeight: 700 },
  table:           { background: "var(--card)", border: "1px solid var(--border)", borderRadius: 16, overflow: "hidden" },
  head:            { background: "var(--bg)", color: "var(--muted)", fontSize: 11, fontWeight: 900, letterSpacing: "0.5px" },
  ...
  modal:           { background: "var(--card)", borderRadius: 20, width: "100%", maxWidth: 560, boxShadow: "0 24px 64px rgba(0,0,0,0.18)", overflow: "hidden", color: "var(--text)" },
  ...
  modalTitle:      { margin: 0, fontSize: 18, fontWeight: 900, color: "var(--text)" },
  ...
  modalFooter:     { display: "flex", justifyContent: "flex-end", gap: 10, padding: "16px 24px", borderTop: "1px solid var(--border)", background: "var(--bg)" },
  cancelBtn:       { padding: "10px 22px", background: "var(--card)", border: "1.5px solid var(--border)", borderRadius: 50, fontSize: 14, fontWeight: 700, color: "var(--text)", cursor: "pointer" },
  ...
  logoSection:     { display: "flex", alignItems: "center", gap: 16, padding: "16px 24px", background: "var(--bg)", borderBottom: "1px solid var(--border)" },
  ...
  input:           { padding: "10px 12px", border: "1.5px solid var(--border)", borderRadius: 10, fontSize: 14, fontFamily: "inherit", color: "var(--text)", background: "var(--card)", outline: "none", width: "100%" },
