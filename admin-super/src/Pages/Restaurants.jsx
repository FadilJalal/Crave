...
const styles = {
  ...
  title: { fontSize: "28px", fontWeight: "800", color: "var(--text)", margin: 0 },
  subtitle: { color: "#64748b", marginTop: "4px" },
  secondaryBtn: { padding: "10px 18px", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: "8px", cursor: "pointer", fontWeight: "600", color: "var(--text)" },
  card: { background: "var(--card)", border: "1px solid var(--border)", borderRadius: "16px", padding: "32px", boxShadow: "var(--shadow)" },
  sectionHeader: { display: "flex", alignItems: "center", gap: "10px", margin: "24px 0 16px 0" },
  sectionTitle: { fontSize: "14px", fontWeight: "700", color: "var(--text)", textTransform: "uppercase", letterSpacing: "1px" },
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "20px" },
  fieldContainer: { display: "flex", flexDirection: "column", gap: "8px" },
  label: { fontSize: "13px", fontWeight: "600", color: "var(--muted)" },
  input: { padding: "12px", borderRadius: "8px", border: "1px solid var(--border)", outline: "none", fontSize: "14px", transition: "border 0.2s", background: "var(--card)", color: "var(--text)" },
  iconInputWrapper: { display: "flex", alignItems: "center", gap: "10px", padding: "0 12px", border: "1px solid var(--border)", borderRadius: "8px", background: "var(--card)" },
  inputBare: { border: "none", outline: "none", width: "100%", padding: "12px 0", fontSize: "14px" },
  actionBtn: { display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", padding: "12px", background: "var(--card)", border: "1px solid #ff4e2a", color: "#ff4e2a", borderRadius: "8px", cursor: "pointer", fontWeight: "600" },
  mapContainer: { height: "320px", borderRadius: "12px", overflow: "hidden", marginTop: "24px", border: "1px solid var(--border)" },
  ...
  dropdown: { position: "absolute", top: "72px", left: 0, right: 0, background: "var(--card)", border: "1px solid var(--border)", borderRadius: "8px", zIndex: 9999, boxShadow: "var(--shadow)", maxHeight: "250px", overflowY: "auto", color: "var(--text)" },
